...
[Explore the project](https://connorblandford.com/projects/cps-space-colocation/). This is the dataset behind an exploratory map; the accompanying article is forthcoming. It examines school space and potential co-location. Health-centre operating status is tracked separately. Snapshot: **9 September 2026**; utilization year: **SY2026**.
